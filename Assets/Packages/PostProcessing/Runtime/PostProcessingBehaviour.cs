...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        void OnEnable()
        {
			if (FindObjectOfType<EnvironmentData>().getType() == "counter")
			{
				profile = GetComponent<CameraProfiles>().counterProfiles[FindObjectOfType<EnvironmentData>().getID()];
			}
			else
			{
				profile = GetComponent<CameraProfiles>().fixtureProfiles[FindObjectOfType<EnvironmentData>().getID()];
			}
